...
export default function CompanyApplications() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["companyApps", id],
        queryFn: () => getCompanyApplications(id, { page: 1, pageSize: 50 }),
    });
    ...
    async function doApprove(appId) {
        try {
            ...
            qc.invalidateQueries({ queryKey: ["companyApps", id] });
        } catch (e) {
