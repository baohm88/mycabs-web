...
export default function DriverApplications(){
  const { data, isLoading } = useQuery({ queryKey:['driverAppsMe'], queryFn: ()=>getMyApplications({ page:1, pageSize:50 }) })
      ...
      {isLoading ? 'Loading…' : (
        <div className="card">
          ...
          <table className="table table-sm mb-0">
            <thead><tr><th>Company</th><th>Status</th><th>When</th></tr></thead>
            <tbody>
              {items.map(a => (
                <tr key={a.id || a.Id}>
